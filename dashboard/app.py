...
with t2:
    ...
    if "EG.ELC.ACCS.UR.ZS" in tg.columns and "EG.ELC.ACCS.RU.ZS" in tg.columns:
        ...
        st.markdown(f"""<div class="interp">
            ...
            <p>La courbe verte (villes) et la courbe bleue (campagnes) racontent une histoire
    ...
    if len(corr_cols)>3:
        ...
        st.markdown(f"""<div class="interp">
            ...
            <span class="b">Bleu (-1)</span> = quand l'une monte, l'autre descend.
...
with t3:
    ...
    if res is not None and not res.empty:
        ...
        with c2:
            ...
            clrs_m = [C["vert"] if v<25 else C["bleu"] if v<40 else C["gris"] for v in ms["mape"]]
            fig = go.Figure(go.Bar(
        ...
        st.markdown(f"""<div class="interp">
            ...
            electrique. Les barres vertes (>0.85) sont excellentes, bleues sont correctes, grises sont faibles.<br><br>
        ...
        if fi_df is not None and not fi_df.empty:
            ...
            n_fi = len(fi_top)
            fi_colors = [f"rgba(10,102,194,{0.3+0.7*i/n_fi})" for i in range(n_fi)]
            fig = go.Figure(go.Bar(
        ...
        rad_colors = [C["bleu"],C["vert"],C["bleu2"],C["vert2"],C["bleu"]]
        fig = go.Figure()
    ...
    if pred is not None and not pred.empty:
        ...
        fig.add_trace(go.Bar(
            ...
            marker_color=C["bleu2"],opacity=0.12,
        ))
        ...
        st.markdown(f"""<div class="interp">
            ...
            La courbe bleue en pointilles montre ce que le modele aurait predit.
            Les barres bleues en transparence montrent l'ecart entre les deux.<br><br>
...
with t4:
    ...
    if proj is not None and not proj.empty:
        ...
        fig.add_annotation(x=lp["year"],y=lp["predicted_gwh"],
                           ...
                           font=dict(size=11,color=C["bleu"]),ax=40,ay=-25)
        ...
        st.markdown(f"""<div class="interp">
            ...
            reelles passees. La <span class="b">courbe bleue</span> a droite montre la prediction
            du modele IA pour les 22 prochaines annees. La <span class="h">zone bleue transparente</span>
        ...
        if not rsel.empty:
            ...
            st.markdown(f"""<div class="interp">
                ...
                represente le niveau actuel ({last_gwh:,.0f} GWh). La barre bleue
